...
public class LoginSteps extends CommonMethods {
   // WebDriver driver;
    ...
    public void user_iis_navigated_to_hrms_application() {

        openBrowserAndLaunchApllicatio();
...
//        WebElement usernameField = driver.findElement(By.id("txtUsername"));
  ...
  //      WebElement passwordField = driver.findElement(By.id("txtPassword"));
    ...
    public void user_enters_different_and_and_verify_the_for_it(String username, String password, String errorMessage) {
       ...
       String errorAcutal= login.errorMessage.getText();
        Assert.assertEquals(errorMessage,errorAcutal);
